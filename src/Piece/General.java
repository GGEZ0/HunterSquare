...
public class General extends Piece_Base{
	//private Image img;
	private ImageView view = new ImageView();
	private int maxtier;
	private int tier;

	public General(int side, int x, int y) {
		super(side, x, y);
		this.name = "General";
		if(side == 0) {
			this.url = "White_GeneralT1.png";
		}
		else {
			this.url = "Black_GeneralT1.png";
		}
	...
	public void changeside() {	
		if(this.side == 0) {
			...
			if(tier == 1) {
				...
				this.url = "Black_GeneralT2.png";
			}
			else if(tier == 3) {
				this.url = "Black_GeneralT3.png";
			}
		}
		else if(this.side == 1) {
			this.side = 0;
			if(tier == 1) {
				...
				this.url = "White_GeneralT2.png";
			}
			else if(tier == 3) {
				this.url = "White_GeneralT3.png";
			}
		}
		this.img = new Image(this.url);
		this.view.setImage(img);
